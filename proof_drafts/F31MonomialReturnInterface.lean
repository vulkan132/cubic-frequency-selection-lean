...
/-! The remaining nonlinear return obligation and its checked denominator-fiber adapter.
This is an INTERNAL CORE OBLIGATION, not an exempted external deep theorem.
No witness of MonomialDenseReturns is constructed or postulated here. -/
...
The nonlinear recurrence itself remains the explicit core premise hR. -/
