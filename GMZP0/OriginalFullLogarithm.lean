...
theorem original_integral_basis_rational_log_coordinates
  ...
  obtain ⟨c, d, bZ, bR, B, K, A, E, L, hc, hb, hB, hK, hpow, hpoly, e, he, hi, he0⟩ :=
    original_integral_basis_time_one_equiv V Gamma coord b hint hcover p hjoint q htri hlow P hP
  ...
  refine ⟨c, d, bZ, bR, B, K, A, E, L, hc, hb, hB, hK, hpow, hpoly, logCoord,
    observationForwardPolynomial EG A E, observationInversePolynomial LG A L, ?_, ?_, ?_, ?_, ?_⟩
  · intro v Q
